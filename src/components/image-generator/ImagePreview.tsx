        ...
        <div className="absolute inset-0 bg-black/40 backdrop-blur-sm transition-all duration-300">
          {isLoading ? (
            ...
            <div className="h-full p-4 animate-fade-in">
              ...
              />
              <Button
                className="absolute bottom-6 right-6 bg-amber-500 hover:bg-amber-600 transition-all duration-300 transform hover:scale-110 hover:shadow-lg"
      ...
      {!generatedImage && !isLoading && !error && (
        <div className="flex items-center justify-center h-full min-h-[300px] md:min-h-[400px] text-gray-400">
          <div className="text-center space-y-4 p-4 animate-fade-in">
            <div className="relative inline-block transition-transform hover:scale-110 duration-300">
