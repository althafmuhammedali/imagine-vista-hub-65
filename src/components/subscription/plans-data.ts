...
export const plans: Plan[] = [
  {
    ...
    imagesPerDay: 25,
    icon: React.createElement(Gem, { className: "w-6 h-6 text-blue-400" }),
  ...
  },
  {
    ...
    imagesPerDay: 100,
    icon: React.createElement(Crown, { className: "w-6 h-6 text-purple-400" }),
  ...
  },
  {
    ...
    icon: React.createElement(Zap, { className: "w-6 h-6 text-amber-400" }),
