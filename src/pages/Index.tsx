    ...
    <div className="min-h-screen bg-gradient-to-br from-[#1a1a1a] via-[#2d2d2d] to-[#1a1a1a] animate-gradient-x">
      ...
      <div className="min-h-screen bg-black/5 backdrop-blur-sm">
        ...
        <div className="container max-w-6xl py-4 sm:py-6 md:py-12 px-4 sm:px-6 lg:px-8">
          <div ref={headerRef} className="space-y-4 md:space-y-6 text-center mb-6 sm:mb-8 md:mb-16">
            ...
            <div className="flex flex-col items-center justify-center gap-4">
              <div ref={featuresRef} className="grid grid-cols-2 sm:grid-cols-4 gap-4 sm:gap-8 my-6">
                <div className="feature-card flex flex-col items-center gap-2 p-4 rounded-lg bg-black/20 backdrop-blur-sm hover:bg-black/30 transition-all transform hover:scale-105">
          ...
          <div ref={generatorRef} className="space-y-8 sm:space-y-12 md:space-y-16 lg:space-y-20">
