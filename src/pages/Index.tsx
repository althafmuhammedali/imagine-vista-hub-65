  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#1a1a1a] via-[#2d2d2d] to-[#1a1a1a] animate-gradient-x">
      <div className="min-h-screen bg-black/5 backdrop-blur-sm">
        <AuthButtons />
        <div className="container max-w-6xl py-6 md:py-12 px-4 sm:px-6 lg:px-8">
          <div className="space-y-4 md:space-y-6 text-center mb-8 md:mb-16 animate-fade-in">
            <div className="flex items-center justify-center gap-2 mb-4">
              <Sparkles className="w-6 h-6 md:w-8 md:h-8 text-amber-400 animate-pulse" />
              <h1 className="text-4xl md:text-5xl lg:text-7xl font-bold tracking-tighter bg-gradient-to-r from-amber-200 via-amber-400 to-amber-200 bg-clip-text text-transparent animate-gradient-x">
                ComicForge AI
              </h1>
              <Sparkles className="w-6 h-6 md:w-8 md:h-8 text-amber-400 animate-pulse" />
            </div>
            ...
            <p className="text-base md:text-lg max-w-2xl mx-auto font-light leading-relaxed text-gray-400 px-4">
